...
class BPF_Collector:
    ...
    def _attach_uretprobe(self, function_name, ebpf_function):
        ...
        self.bpf.attach_uretprobe(
            name=self.program, fn_name=ebpf_function, sym=function_name, pid=self.pid
        )
    ...
    def start(self):
        ...
        if self.instrument_options:
            self._attach_uretprobe("CreateQueryDesc", "createquerydesc_ret")
    ...
    def prepare_bpf(self) -> BPF:
        ...
        return BPF(text=buf, cflags=cflags)
